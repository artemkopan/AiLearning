...
import io.artemkopan.ai.sharedcontract.DeleteBranchCommandDto

class DeleteBranchWsUseCase(
    private val agentRepository: AgentRepository,
    private val outboundService: AgentWsOutboundService,
) : AgentWsMessageUseCase<DeleteBranchCommandDto> {
    override val messageType = DeleteBranchCommandDto::class

    override suspend fun execute(context: AgentWsMessageContext, message: DeleteBranchCommandDto): Result<Unit> {
